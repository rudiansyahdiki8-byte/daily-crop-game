// api/gameConfig.js
// DATA SAMA PERSIS DENGAN js/config.js 

export const GameConfig = {
    // 1. SETTING TANAMAN (Sesuai js/config.js baris 1776)
    Crops: {
        // Common
    ...
    // 2. HARGA MEMBERSHIP (Sesuai js/config.js baris 1781)
    Plans: {
        FREE: 0,
        MORTGAGE: 20,   // USDT
        TENANT: 30,     // USDT
    ...
    // 3. SETTING MARKET (Sesuai js/config.js baris 1782)
    ShopItems: {
    ...
    // 4. SETTING SPIN/RODA (Sesuai js/config.js baris 1784)
    Spin: {
        CostPaid: 150,          // Biaya Spin Berbayar (PTS)
        CooldownFree: 3600000,  // Waktu Tunggu Gratis (1 Jam)
    ...
    // 5. SETTING WITHDRAW (Sesuai js/config.js baris 1785)
    Finance: {
    ...
    // 6. HADIAH TUGAS HARIAN (Sesuai js/config.js baris 1786)
    Tasks: {
        Login: 120,
        Visit: 120,
        Gift: 120,
