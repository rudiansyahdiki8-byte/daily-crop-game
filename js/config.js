...
window.GameConfig = {
    ...
    Crops: {
        ginger:     { time: 240, minPrice: 20, maxPrice: 50, chance: 10.0 }, // 3 Menit
        ...
        // Uncommon
        chili:      { time: 300, minPrice: 50, maxPrice: 70, chance: 6.0 }, // 4 Menit
        ...
        // Rare
        aloeVera:   { time: 420, minPrice: 120, maxPrice: 250, chance: 2.0 }, // 5 Menit
        ...
        // Epic
        cinnamon:   { time: 480, minPrice: 400, maxPrice: 800, chance: 0.5 }, // 6 Menit
        ...
        // Legendary
        vanilla:    { time: 720, minPrice: 2000, maxPrice: 8000, chance: 0.1 }, // 10 Menit
