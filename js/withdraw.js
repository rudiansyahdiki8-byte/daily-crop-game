...
const WithdrawSystem = {
    ...
    // Pilihan Cepat (Shortcut Buttons)
    quickAmounts: [100, 1000, 5000, 10000, 50000],

    // Rate Tukar (USDT Ambil dari Config, sisanya estimasi statis)
    rates: {
        USDT: window.GameConfig.Finance.RateUSDT, // Terkoneksi Config!
        TRX: 0.00006,       
        LTC: 0.0000001,
        DOGE: 0.00003,
        SOL: 0.00000005,
    ...
    renderForm() {
        ...
        // Reset Container agar rapi (Tambahkan style container di sini)
        ...
        wdArea.innerHTML = `
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 class="text-xl font-black text-white italic uppercase tracking-wider">Withdraw</h2>
                    <p class="text-[8px] text-gray-400 font-bold uppercase tracking-widest">Cashout Earnings</p>
                </div>
            ...
            <button onclick="WithdrawSystem.process()" class="w-full bg-gradient-to-r from-emerald-600 to-emerald-500 text-white py-4 rounded-[1.5rem] font-black uppercase text-[10px] shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2 mt-auto shrink-0">Process <i class="fas fa-arrow-right"></i></button>
        `;
