...
renderSellInventory() {
    ...
    openSellModal(key, maxQty, price) {
        ...
        UIEngine.showRewardPopup("SELL ITEM", `
            <div class="text-center mb-8"><h3 class="text-lg font-black text-emerald-400 uppercase">${plantName}</h3><p class="text-[9px] text-gray-400">Price: ${price} PTS/unit</p></div>
