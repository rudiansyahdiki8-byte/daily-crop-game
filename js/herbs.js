...
const HerbAssets = {
    ...
    turmeric:    { name: 'Turmeric', img: 'https://img.icons8.com/color/96/turmeric.png', rarity: 'Common' },
    galangal:    { name: 'Galangal', img: 'https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-ginger-vegetables-flaticons-flat-flat-icons-2.png', rarity: 'Common' },
    lemongrass:  { name: 'Lemongrass', img: 'https://img.icons8.com/color/96/lemongrass.png', rarity: 'Common' },
    cassava:     { name: 'Cassava', img: 'https://img.icons8.com/color/96/cassava.png', rarity: 'Common' },

    // UNCOMMON
    chili:       { name: 'Red Chili', img: 'https://img.icons8.com/color/96/chili-pepper.png', rarity: 'Uncommon' },
    pepper:      { name: 'Pepper', img: 'https://img.icons8.com/color/96/pepper-shaker.png', rarity: 'Uncommon' },
    ...
    stevia:      { name: 'Stevia', img: 'https://img.icons8.com/color/96/tea-plant.png', rarity: 'Rare' },
    ...
    cardamom:    { name: 'Cardamom', img: 'https://img.icons8.com/color/96/waffle.png', rarity: 'Epic' },
    clove:       { name: 'Clove', img: 'https://img.icons8.com/color/96/clove.png', rarity: 'Epic' },

    // LEGENDARY
    vanilla:     { name: 'Vanilla', img: 'https://img.icons8.com/color/96/vanilla.png', rarity: 'Legendary' },
    saffron:     { name: 'Saffron', img: 'https://img.icons8.com/color/96/saffron.png', rarity: 'Legendary' }
};
