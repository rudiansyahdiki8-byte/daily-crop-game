...
const executeAdType = async (type) => {
    ...
    if (type === 'ADSGRAM_INT') {
        ...
        try {
            console.log("🔄 Rolling: Adsgram Int");
    ...
    if (type === 'ADSGRAM_REW') {
        ...
        try {
            console.log("🔄 Rolling: Adsgram Reward");
    ...
    if (type === 'MONETAG_POP') {
        ...
        try {
            console.log("🔄 Rolling: Monetag Popup");
    ...
    if (type === 'MONETAG_INT') {
        ...
        try {
            console.log("🔄 Rolling: Monetag Interstitial");
            const f = window[`show_${IDS.MONETAG_ZONE_TWA}`];
            if (typeof f === 'function') {
                await f();
    ...
    if (type === 'ADSTERRA_LINK') {
        ...
        console.log("🔄 Rolling: Adsterra Link");
        try {
    ...
    if (type === 'MONETAG_LINK') {
        ...
        console.log("🔄 Rolling: Monetag Link");
        try {
