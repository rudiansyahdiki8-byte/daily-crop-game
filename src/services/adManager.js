...
const getSingleAd = async () => {
    ...
    if (checkCooldown('cd_adsgram_int') && window.Adsgram) {
        try {
            ...
            return true;
        } catch { console.warn("Pass Adsgram Int"); }
    }
    ...
    if (checkCooldown('cd_adsgram_rew') && window.Adsgram) {
        ...
        } catch { console.warn("Pass Adsgram Rew"); }
    }
    ...
    if (checkCooldown('cd_adextra')) {
        ...
        } catch { console.warn("Pass AdExtra"); }
    }
    ...
    if (checkCooldown('cd_monetag_pop')) {
        ...
        } catch { console.warn("Pass Monetag Pop"); }
    }
    ...
    if (checkCooldown('cd_monetag_int')) {
        ...
        } catch { console.warn("Pass Monetag Int"); }
    }
    ...
    if (checkCooldown('cd_gigapub_int')) {
        ...
        } catch { console.warn("Pass GigaPub Int"); }
    }
