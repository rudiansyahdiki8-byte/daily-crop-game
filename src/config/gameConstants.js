...
export const PLANS = {
  FREE: { id: "FREE", price: 0, plots: 1, storage: 50, bonusSell: 0, ads: "High" },
  ...
  OWNER: { id: "OWNER", priceUsdt: 50, plots: 8, storage: Infinity, bonusSell: 0.30, ads: "None" },
};

// --- DATABASE VISUAL GLOBAL (ICON & COLOR) ---
...
export const CROPS = {
  COMMON: {
     chance: 0.10, growthTime: 240, priceRange: [20, 50],
     items: ["Cabbage", "Spinach", "Water Spinach", "Corn", "Eggplant"]
  },
  UNCOMMON: {
     chance: 0.06, growthTime: 300, priceRange: [50, 70],
     items: ["Tomato", "Carrot", "Broccoli", "Potato", "Cucumber"]
  },
  RARE: {
     chance: 0.02, growthTime: 420, priceRange: [120, 250],
     items: ["Asparagus", "Bell Pepper", "Cauliflower", "Purple Cabbage", "Oyster Mushroom"]
  },
  EPIC: {
     chance: 0.005, growthTime: 480, priceRange: [400, 800],
     items: ["Shiitake Mushroom", "Artichoke", "Bamboo Shoot", "Giant Pumpkin"]
  },
  LEGENDARY: {
    chance: 0.001, growthTime: 720, priceRange: [2000, 8000],
    items: ["Wasabi", "Black Garlic", "Black Truffle"]
  }
};
