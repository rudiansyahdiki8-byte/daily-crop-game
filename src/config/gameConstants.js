...
export const GAME_CONFIG = {
  ...
  // KONFIGURASI BOT (REFERRAL SYSTEM)
  // Ganti dengan username bot Anda (tanpa @). 
  // Contoh: "Daily_Cropbot/play" jika pakai direct attachment, atau "Daily_Cropbot" saja.
  BOT_USERNAME: "Daily_Cropbot/play"
};
...
export const CONSUMABLES = {
  SPEED_SOIL: { id: 'SPEED_SOIL', name: 'Speed Soil', price: 500, desc: '-10% Growth Time (24 Hours)' },
  GROWTH_FERT: { id: 'GROWTH_FERT', name: 'Growth Fertilizer', price: 1000, desc: '-20% Growth Time (24 Hours)' },
  TRADE_PERMIT: { id: 'TRADE_PERMIT', name: 'Trade Permit', price: 1500, desc: '+10% Sell Price (24 Hours)' },
  RARE_ESSENCE: { id: 'RARE_ESSENCE', name: 'Rare Essence', price: 2000, desc: '+20% Rare Chance (24 Hours)' },
  SCARECROW: { id: 'SCARECROW', name: 'Golden Scarecrow', price: 3000, desc: 'Lucky! Rare-Legend Chance x3 (24 Hours)' },
};
