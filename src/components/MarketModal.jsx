...
<div style={{
                ...
                overflow: 'hidden' /* <--- PENTING: Agar wadah tidak melar ke bawah */
            }}>
                ...
                <div className="no-scrollbar" style={{
                    flex:1, overflowY:'scroll', /* Pakai scroll, bukan auto */
                    display:'flex', flexDirection:'column', gap:5,
                    scrollbarWidth: 'none', /* Firefox: Sembunyikan Scrollbar */
                    msOverflowStyle: 'none' /* IE/Edge: Sembunyikan Scrollbar */
                }}>
                    {sellList.map(name => (
                        <div key={name} style={{
                            display:'flex', justifyContent:'space-between', alignItems:'center',
                            background:'rgba(255,255,255,0.05)', padding:'5px 8px', borderRadius:8,
                            flexShrink: 0 /* Agar item tidak tergencet */
                        }}>
                ...
                {/* CSS INLINE UNTUK SEMBUNYIKAN SCROLLBAR DI CHROME */}
                <style>{`
