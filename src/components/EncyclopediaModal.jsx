...
// Helper for time format (Seconds -> Minutes/Hours)
...
const EncyclopediaModal = ({ isOpen, onClose }) => {
  ...
  // Filter Tab State (All, Common, Rare, etc.)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        // GLASSMORPHISM CONTAINER (Consistent with Warehouse)
        background: 'linear-gradient(160deg, rgba(30,30,40,0.95) 0%, rgba(10,10,20,0.98) 100%)',
        border: '1px solid rgba(224, 64, 251, 0.3)', // Neon Purple Border (Wiki Style)
        borderRadius: 20,
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: 15 }}>
          {Object.entries(CROPS).map(([rarityKey, data]) => {
            ...
            // Determine Header Color based on Rarity (Sample from first item)
