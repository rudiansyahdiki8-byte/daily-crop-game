...
const FriendsModal = ({ isOpen, onClose, user, onRefresh }) => {
    ...
    // --- FRIEND LIST LOGIC ---
    // Convert 'referrals' data (Object) to Array for looping
    // Data Format from Backend: { "ID123": { username: "Budi", totalBonusGiven: 500 }, ... }
    const friendsList = user?.referrals ? Object.values(user.referrals) : [];

    // Sort friends by who gave the most money (High to Low)
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                            {friendsList.map((friend, idx) => (
                                <div key={idx} style={{
                                    ...
                                    border: idx < 3 ? '1px solid rgba(255, 215, 0, 0.2)' : '1px solid transparent' // Top 3 get thin gold border
                                }}>
