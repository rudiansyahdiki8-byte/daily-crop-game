      ...
      if (tg && tg.initDataUnsafe?.user) {
        ...
        try {
          ...
          if (startParam && !userData.uplineId && String(startParam) !== String(realId)) {
            try {
              if (process.env.NODE_ENV === 'development') console.log("Auto-Binding to:", startParam);
              ...
              if (process.env.NODE_ENV === 'development') console.log("Auto-Bind skipped:", err.message);
            }
          }
          // -----------------------
