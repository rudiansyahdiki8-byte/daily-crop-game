...
const UIEngine = {
    ...
    showLoading(msg = "SINKRONISASI SERVER...") {
        const loader = document.createElement('div');
        loader.id = "global-loader";
        loader.className = "fixed inset-0 bg-black/90 z-[9999] flex flex-col items-center justify-center";
        loader.innerHTML = `
            <div class="w-10 h-10 border-4 border-amber-500 border-t-transparent rounded-full animate-spin mb-4"></div>
            <div class="text-white text-[10px] font-black tracking-widest uppercase">${msg}</div>
        `;
